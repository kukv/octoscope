...
func TestALogLineKeepsTheStampOutOfTheText(t *testing.T) {
	...
	line := ParseLogLine("Run tests", "\ufeff2026-09-07T09:15:22.1234567Z ok  \tgithub.com/kukv/octoscope\t0.4s")
...
func TestAnUnstampedLineKeepsItsWholeText(t *testing.T) {
	...
	line := ParseLogLine("Run tests", "    expected 3, got 4")
...
func TestAFirstWordThatIsNotATimestampStays(t *testing.T) {
	...
	line := ParseLogLine("Run tests", "2026-09-07 09:15:22 starting")
