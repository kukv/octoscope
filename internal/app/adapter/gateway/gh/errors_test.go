...
func TestEveryOverrideKeepsFatalErrorsFatal(t *testing.T) {
	...
	g := New(fakeBackend{
		...
		addPRComment:       func(context.Context, string, int, string) error { return authErr },
		addIssueComment:    func(context.Context, string, int, string) error { return authErr },
		closePR:            func(context.Context, string, int) error { return authErr },
		reopenPR:           func(context.Context, string, int) error { return authErr },
		closeIssue:         func(context.Context, string, int) error { return authErr },
		reopenIssue:        func(context.Context, string, int) error { return authErr },
		editPRLabels:       func(context.Context, string, int, []string, []string) error { return authErr },
		editIssueLabels:    func(context.Context, string, int, []string, []string) error { return authErr },
		editPRAssignees:    func(context.Context, string, int, []string, []string) error { return authErr },
		editIssueAssignees: func(context.Context, string, int, []string, []string) error { return authErr },
	})
