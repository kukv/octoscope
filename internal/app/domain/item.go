...
// Item and Change carry no JSON tags: what a backend receives is that
// backend's business, and the gateway translates GitHub's own spelling into
// the values above before handing anything over.
//
